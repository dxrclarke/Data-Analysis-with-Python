...
def calculate_demographic_data(print_data=True):
    ...
    rich_percentage = df.loc[df['hours-per-week'] == 1, 'salary'].value_counts(normalize=True)['>50K'] * 100
    ...
    highest_earning_country_percentage = round((country_rich_count / country_count).max() * 100, 1)
